...
This respository includes Microsoft Word templates of the (1) **title page**, (2) the **manuscript**, (3) the **supplementary materials**, and (4) the **non-English abstract** for submissions to the journal Geomorphica (https://geomorphica.org). All submissions are **REQUIRED** to use our templates. The LaTeX templates are also available here: https://github.com/Geomorphica/LaTex_template.git
